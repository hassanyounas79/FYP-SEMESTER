// ignore_for_file: prefer_const_constructors, empty_catches, unused_local_variable
                          ...
                          Expanded(
                            ...
                            child: values.isEmpty
                                ...
                                : ListView.builder(
                                    ...
                                    shrinkWrap: true,
                                    itemBuilder: (_, index) {
                                      int pNO = snapDs.value["users"][sID]
                                          ['projects'];
                                      late String sup = "";
                                      late String temp = "";
                                      late String name = "";
                                                    ...
                                                    ElevatedButton(
                                                      ...
                                                      onPressed: () async {
                                                        ...
                                                        await FirebaseCon.ref
                                                            .reference()
                                                            .child(
                                                                "users/faculty/$sup/approved/${values[index]}")
                                                            .remove();
                                                        await FirebaseCon.ref
                                                            .reference()
                                                            .child(
                                                        ...
                                                        FirebaseCon.ref
                                                            .reference()
                                                            .child(
                                                                "users/$sID/pending/${values[index]}")
                                                            .remove();
                                                      },
                                                      child: Text("Reject"),
                                                    ),
                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            child: ListView.builder(
                                ...
                                itemBuilder: (_, index) {
                                  int pNO =
                                      snapDs.value["users"][sID]['projects'];
                                  late String sup =
                                      snapDs.value["pending_projects"]
                                          ["${values[index]}"]["supervisor"];
                                  late String temp;
                                  late String temp2;
                                  String gm = snapDs.value["pending_projects"]
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              "${snapDs.value["users"]["faculty"][sup]["name"]}",
                                              style: TextStyle(fontSize: 14),
                                            ),
                                          ],
                                        )
